...
vi.mock('@withwiz/toolkit/core/config/common', () => ({
...
describe('Cache Env', () => {
  ...
  describe('getConfig', () => {
    it('should return ISharedEnvConfig with correct env mapping', async () => {
      const { getConfig } = await import('@withwiz/toolkit/core/cache/cache-env');
  ...
  describe('getEnv', () => {
    it('should return raw env values from config', async () => {
      const { getEnv } = await import('@withwiz/toolkit/core/cache/cache-env');
  ...
  describe('isCacheEnabled', () => {
    it('should return true when config.enabled is true', async () => {
      const { isCacheEnabled } = await import('@withwiz/toolkit/core/cache/cache-env');
  ...
  describe('validateRedisEnvironment', () => {
    it('should return isValid true when url and token are present', async () => {
      const { validateRedisEnvironment } = await import('@withwiz/toolkit/core/cache/cache-env');
  ...
  describe('getCacheFallbackConfig', () => {
    it('should return fallback config with threshold values', async () => {
      const { getCacheFallbackConfig } = await import('@withwiz/toolkit/core/cache/cache-env');
  ...
  describe('getCacheHealthConfig', () => {
    it('should return health config with threshold values', async () => {
      const { getCacheHealthConfig } = await import('@withwiz/toolkit/core/cache/cache-env');
