 ...
 *
 * Tests for src/core/error/friendly-messages-v2.ts
 * - getFriendlyMessage
 * - getErrorDisplayInfo
 * - formatFriendlyError
 */
...
describe('friendly-messages-v2', () => {
  ...
  describe('getFriendlyMessage', () => {
    it('should return IErrorMessage with title and description for known code', async () => {
      const { getFriendlyMessage } = await import('@withwiz/toolkit/core/error/friendly-messages-v2');
  ...
  describe('getErrorDisplayInfo', () => {
    it('should return IErrorDisplay with all required fields', async () => {
      const { getErrorDisplayInfo } = await import('@withwiz/toolkit/core/error/friendly-messages-v2');
  ...
  describe('formatFriendlyError', () => {
    it('should return formatted string with title, description, and code', async () => {
      const { formatFriendlyError } = await import('@withwiz/toolkit/core/error/friendly-messages-v2');
