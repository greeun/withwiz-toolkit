...
describe('error-display', () => {
  ...
  describe('showFriendlyError', () => {
    it('should show toast with error severity for server category code', async () => {
      const { showFriendlyError } = await import('@withwiz/react/error/error-display');
  ...
  describe('handleApiResponse', () => {
    it('should return data on successful response', async () => {
      const { handleApiResponse } = await import('@withwiz/react/error/error-display');
      const mockResponse = {
        ok: true,
  ...
  describe('formatInlineError', () => {
    it('should return formatted string with description and code', async () => {
      const { formatInlineError } = await import('@withwiz/react/error/error-display');
  ...
  describe('getErrorIcon', () => {
    it('should return ⚠️ for validation category (400xx)', async () => {
      const { getErrorIcon } = await import('@withwiz/react/error/error-display');
  ...
  describe('getDefaultErrorCode', () => {
    it('should map 400 → 40002', async () => {
      const { getDefaultErrorCode } = await import('@withwiz/react/error/error-display');
  ...
  describe('extractErrorInfo', () => {
    it('should extract code from AppError (code >= 10000)', async () => {
      const { extractErrorInfo } = await import('@withwiz/react/error/error-display');
      const { AppError } = await import('@withwiz/core/error/app-error');
      const error = AppError.notFound('Test');
