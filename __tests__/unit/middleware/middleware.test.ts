...
vi.mock('@withwiz/toolkit/next/middleware/error-handler', () => ({
...
vi.mock('@withwiz/toolkit/next/middleware/security', () => ({
...
vi.mock('@withwiz/toolkit/next/middleware/cors', () => ({
...
vi.mock('@withwiz/toolkit/next/middleware/init-request', () => ({
...
vi.mock('@withwiz/toolkit/next/middleware/auth', () => ({
...
vi.mock('@withwiz/toolkit/next/middleware/rate-limit', () => ({
  rateLimitMiddleware: {
...
vi.mock('@withwiz/toolkit/next/middleware/response-logger', () => ({
...
describe('Middleware Wrappers', () => {
  ...
  describe('withAuthApi', () => {
    it('should include authMiddleware between initRequest and rateLimit', async () => {
      const { withAuthApi } = await import('@withwiz/toolkit/next/middleware/wrappers');
  ...
  describe('withAdminApi', () => {
    it('should include both authMiddleware and adminMiddleware', async () => {
      ...
      const { withAdminApi } = await import('@withwiz/toolkit/next/middleware/wrappers');
  ...
  describe('withCustomApi', () => {
    it('should allow building a custom middleware chain', async () => {
      const { withCustomApi } = await import('@withwiz/toolkit/next/middleware/wrappers');
      const { errorHandlerMiddleware } = await import('@withwiz/toolkit/next/middleware/error-handler');
      const { initRequestMiddleware } = await import('@withwiz/toolkit/next/middleware/init-request');
      const { responseLoggerMiddleware } = await import('@withwiz/toolkit/next/middleware/response-logger');
