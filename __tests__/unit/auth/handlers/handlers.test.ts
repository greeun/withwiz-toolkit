...
vi.mock('@withwiz/toolkit/core/auth/services/register.service', () => ({
...
vi.mock('@withwiz/toolkit/core/auth/services/password-reset.service', () => ({
...
vi.mock('@withwiz/toolkit/core/auth/services/email-verification.service', () => ({
