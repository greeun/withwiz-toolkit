...
### Chore
- Removed the stray `pnpm-workspace.yaml` from the repository (and purged it
  from git history). This package is npm-only; the file was never part of the
  published package and had no effect on consumers.
